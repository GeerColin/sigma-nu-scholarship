...
export default async function StudyHoursPage({
  ...
  searchParams: Promise<{ filter?: string; status?: string; error?: string }>;
}) {
  ...
  return (
    <ChairAppShell>
      <PageHeading
        ...
        title="Study hours"
        description="Review calculated requirements, completed proctor-recorded minutes, overrides, and frozen assignments."
      />
        ...
        <CardContent>
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
            <div>
              <p className="font-bold text-[var(--navy)]">
                {activeRule
                  ? `Active rule set · Version ${activeRule.version}`
                  : "No active study-hour rule set"}
              </p>
              <p className="mt-1 text-sm text-[var(--muted)]">
                Rule changes create a new immutable version. Existing frozen
                assignments remain frozen and move to review when requirements
                change.
              </p>
            </div>
          ...
          <details className="mt-5 rounded-xl border" open={!activeRule}>
            <summary className="cursor-pointer p-4 font-semibold text-[var(--navy)]">
              {activeRule ? "Create a new rule-set version" : "Configure rules"}
            </summary>
            <form
        ...
        <Card>
          <CardContent>
            ...
            <p className="mt-2 text-[var(--muted)]">
              Configure an active semester before managing weekly study hours.
            </p>
            <Link
              href="/settings"
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-4">
                          ...
                          {member.assignmentState === "review_required" && (
                        ...
                        <td className="py-4">
                          {member.assignmentId ? (
                            <details className="min-w-64 rounded-xl border">
                              ...
                              <div className="space-y-4 border-t p-3">
                                ...
                                {["draft", "ready"].includes(
                                  ...
                                  <form action={freezeStudyHourAssignment}>
                                    <input
                                      type="hidden"
                                      name="assignmentId"
                                      value={member.assignmentId}
