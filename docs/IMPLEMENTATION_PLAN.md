...
- [!] A dashboard academic-status read failed once, recovered through Try again, and did not recur during the 75 measurements. Vercel logs confirm the generic read failure but not its underlying cause; no root-cause fix is claimed.
